...
public class Class002 {
    public static void main(String[] args) {
        System.out.println("If <branch> is specified rtyhbrthyh, git rebase will perform an automatic git switch <branch> before doing anything else. Otherwise it remains on the current branch.\n" +
                "\n" +
